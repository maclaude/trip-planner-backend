    ...
    await transporter.sendMail({
      ...
      html: `
        ...
        <div>
          ...
          <p>Cliques sur le <a href="https://trip-planner-app-backend.herokuapp.com/project/invitation/${token}">lien suivant</a> pour commencer l'aventure &#128640;<p>
        </div>
      `,
    });
...
exports.checkProjectInvitationToken = async (req, res, next) => {
  ...
  try {
    ...
    res.redirect(`https://www.trip-planner.site/invitation/${projectId}`);
  } catch (err) {
    if (!err.statusCode) {
      err.statusCode = 500;
    }
